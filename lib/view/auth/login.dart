...
class _LoginViewState extends State<LoginView> {
  ...
  Widget _buildMainBody(
    ...
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: isDesktop ? size.width * 0.1 : 20.0,
        // Padding vertical adaptatif - position plus haute par défaut
        vertical: isMobile 
            ? (keyboardHeight > 0 ? 10.0 : 30.0)  // Réduit de 20.0 à 30.0 par défaut
            : 1.0,
      ),
      child: Column(
        // Alignement adaptatif selon la présence du clavier
        mainAxisAlignment: keyboardHeight > 0 
            ? MainAxisAlignment.start 
            : MainAxisAlignment.center,
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          // Espacement en haut adaptatif - plus petit par défaut
          SizedBox(
            height: keyboardHeight > 0
                ? 5  // Très petit quand clavier ouvert
                : (isMobile ? 20 : 60),  // Réduit de 40 à 20 pour mobile
          ),

          // Logo - garde sa taille comme demandé
          Center(
            child: Image.asset(
              'assets/migo_logo.png',
              width: isDesktop ? size.width / 6 : size.width / 1.5,
          ...
          SizedBox(height: keyboardHeight > 0 ? 10 : 15),  // Espacement réduit avec clavier
          ...
          SizedBox(height: keyboardHeight > 0 ? 15 : 20),  // Espacement réduit avec clavier
          ...
          SizedBox(
            height: keyboardHeight > 0
                ? 10  // Petit espacement quand clavier ouvert
                : (isMobile ? 15 : 40),  // Réduit de 20 à 15 pour mobile
          ),
        ],
      ),
    );
