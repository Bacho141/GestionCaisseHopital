...
// import 'package:migo/controller/service_controller.dart';
...
//                   children: [
//                     FadeInImage(
//                       image: NetworkImage(product.label.toString()),
//                       placeholder:
...
//                     Text(
//                       "₹" +
//                           product.tarif.toString().substring(
//                               0, product.tarif.toString().length - 3),
//                       overflow: TextOverflow.ellipsis,
//                       style: const TextStyle(
...
//                       //         ),
//                       //       );
//                       //       var sellpr = product.tarif.toString();
