              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "(₹ ${widget.product.tarif.toString().substring(0, widget.product.tarif.toString().length - 3)})",
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                      ),
                    ...
                    QuantityInput(
                      ...
                      onChanged: (val) {
                        ...
                        var priceOfTheItem = int.parse(widget.invoiceController
                            .productList[widget.index].tarif
                            .toString()
                            .substring(
                                0,
              ...
              PrimaryButton(
                onPressed: () {
                  var priceToBeDeducted = int.parse(widget
                      .invoiceController.productList[widget.index].tarif
                      .toString()
                      .substring(
                          0,
